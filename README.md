...
git clone https://github.com/MandeepKharb/UPI-Fraud-Detection.git
...
The application is now ready to analyze UPI transactions.
...
4\. Submit the transaction for analysis.

5\. View the prediction indicating whether the transaction is \*\*Legitimate\*\* or \*\*Fraudulent\*\*.
